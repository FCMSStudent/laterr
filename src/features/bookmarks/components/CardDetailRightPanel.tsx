 ...
 * 
 * This component enforces a fixed layout with non-scrollable sections:
 * - Header: Title (2-line clamp) + metadata
 * - Actions: Open + Copy buttons
...
export const CardDetailRightPanel = ({
  ...
  return (
    <div className="flex flex-col h-full max-h-full min-h-0 border-l border-border/40 pl-6 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-h-0 py-1 space-y-4">
        ...
        <div className="space-y-1.5 flex-1 flex flex-col min-h-0">
          ...
          <div className="relative card-detail-notes flex-shrink-0">
            <Textarea
              ref={notesRef}
              ...
              onBlur={onNotesSave}
              className="w-full border border-border/40 rounded-lg bg-muted/20 p-3 focus-visible:ring-1 text-sm leading-relaxed placeholder:text-muted-foreground/40"
            />
      ...
      {/* FOOTER: Delete action - pinned bottom-right */}
      <div className="py-3 flex items-center justify-end border-t border-border/40 flex-shrink-0">
        <Button
          variant="ghost"
          size="sm"
          onClick={onDelete}
