...
// Lazy load modal components for better code splitting and performance
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      ...
      <main id="main-content">
        ...
        {loading ? <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-5 md:gap-6 pb-12">
          ...
          {viewMode === 'grid' ? <div className="columns-2 sm:columns-2 lg:columns-3 xl:columns-4 gap-3 md:gap-6 pt-1 pb-12">
