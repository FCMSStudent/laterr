...
const AppContent = () => {
  ...
  return <div>
      <Routes>
        ...
        <Route path="/bookmarks" element={<Bookmarks />} className="bg-stone-100" />
        <Route path="/subscriptions" element={<Subscriptions />} />
        <Route path="/health" element={<Health />} />
        <Route path="/settings" element={<Settings />} />
        <Route path="/auth" element={<Auth />} />
        <Route path="/landing" element={<Landing />} />
        {process.env.NODE_ENV === "development" && <Route path="/viewer-loading-test" element={<ViewerLoadingTestPage />} />}
