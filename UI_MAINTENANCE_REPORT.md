...
Generated on: 3/22/2026, 1:23:25 AM
...
| Type | Description | File | Line |
| --- | --- | --- | --- |
| accessibility | Form element <Input> missing accessible label (aria-label or associated <label>) | *Multiple (7 files)* | - |
...
| accessibility | Form element <Select> missing accessible label (aria-label or associated <label>) | *Multiple (40 files)* | - |
| accessibility | Form element <input> missing accessible label (aria-label or associated <label>) | *Multiple (8 files)* | - |
...
| Type | Description | File | Line |
| --- | --- | --- | --- |
| consistency | Raw <button> tag used; consider using the standard Button component | *Multiple (21 files)* | - |
