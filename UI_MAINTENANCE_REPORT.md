...
Generated on: 3/17/2026, 1:29:20 AM
...
| Type | Description | File | Line |
| --- | --- | --- | --- |
| accessibility | Form element <Input> missing accessible label | `src/shared/components/NavigationHeader.tsx` | 136 |
| accessibility | Icon-only <Button> missing aria-label | `src/features/health/components/MeasurementCard.tsx` | 91 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 304 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 305 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 306 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 308 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 310 |
| accessibility | Form element <input> missing accessible label | `src/features/health/components/AddHealthDocumentModal.tsx` | 395 |
| accessibility | Icon-only <Button> missing aria-label | `src/features/health/components/HealthDocumentCard.tsx` | 61 |
| accessibility | Form element <Input> missing accessible label | `src/features/health/components/HealthChatPanel.tsx` | 274 |
| accessibility | Icon-only <Button> missing aria-label | `src/features/health/components/HealthChatPanel.tsx` | 180 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddMeasurementModal.tsx` | 146 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddMeasurementModal.tsx` | 147 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddMeasurementModal.tsx` | 148 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddMeasurementModal.tsx` | 150 |
| accessibility | Form element <Select> missing accessible label | `src/features/health/components/AddMeasurementModal.tsx` | 152 |
| accessibility | Form element <input> missing accessible label | `src/features/bookmarks/components/ChecklistItem.tsx` | 58 |
| accessibility | Form element <input> missing accessible label | `src/features/bookmarks/components/RichNotesEditor.tsx` | 323 |
| accessibility | Form element <input> missing accessible label | `src/features/bookmarks/components/NumberedItem.tsx` | 53 |
| accessibility | Form element <Input> missing accessible label | `src/features/bookmarks/components/NoteEditorModal.tsx` | 99 |
| accessibility | Form element <input> missing accessible label | `src/features/bookmarks/components/HeadingItem.tsx` | 59 |
| accessibility | Form element <input> missing accessible label | `src/features/bookmarks/components/BulletItem.tsx` | 51 |
| accessibility | Form element <Textarea> missing accessible label | `src/features/bookmarks/components/DetailViewModal.tsx` | 528 |
| accessibility | Icon-only <Button> missing aria-label | `src/features/bookmarks/components/DetailViewModal.tsx` | 535 |
| accessibility | Form element <Input> missing accessible label | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 229 |
| accessibility | Form element <Input> missing accessible label | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 254 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 205 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 206 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 207 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 209 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 211 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 235 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 236 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 237 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 239 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 241 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 253 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 254 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 255 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 257 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 259 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 243 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 244 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 245 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 247 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 249 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 273 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 274 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 275 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 277 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 279 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 298 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 299 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 300 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 302 |
| accessibility | Form element <Select> missing accessible label | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 304 |
| accessibility | Form element <input> missing accessible label | `src/features/core/pages/ViewerLoadingTestPage.tsx` | 33 |
| accessibility | Form element <input> missing accessible label | `src/features/core/pages/ViewerLoadingTestPage.tsx` | 67 |
| accessibility | Form element <Input> missing accessible label | `src/features/core/pages/ComponentShowcasePage.tsx` | 472 |
| accessibility | Form element <Input> missing accessible label | `src/features/core/pages/ComponentShowcasePage.tsx` | 486 |
