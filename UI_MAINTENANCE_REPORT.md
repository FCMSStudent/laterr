...
Generated on: 2/27/2026, 1:28:08 AM
...
| --- | --- | --- | --- |
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/bookmarks/components/NoteEditorModal.tsx` | 99 |
...
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 229 |
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 254 |
...
| accessibility | Form element <Textarea> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/bookmarks/components/DetailViewModal.tsx` | 528 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddHealthDocumentModal.tsx` | 304 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddHealthDocumentModal.tsx` | 305 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddHealthDocumentModal.tsx` | 306 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddHealthDocumentModal.tsx` | 308 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddHealthDocumentModal.tsx` | 310 |
...
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/HealthChatPanel.tsx` | 274 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddMeasurementModal.tsx` | 146 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddMeasurementModal.tsx` | 147 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddMeasurementModal.tsx` | 148 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddMeasurementModal.tsx` | 150 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/health/components/AddMeasurementModal.tsx` | 152 |
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/core/pages/ComponentShowcasePage.tsx` | 472 |
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/core/pages/ComponentShowcasePage.tsx` | 486 |
...
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 205 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 206 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 207 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 209 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 211 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 235 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 236 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 237 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 239 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 241 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 253 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 254 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 255 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 257 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/EditSubscriptionModal.tsx` | 259 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 243 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 244 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 245 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 247 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 249 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 273 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 274 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 275 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 277 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 279 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 298 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 299 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 300 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 302 |
| accessibility | Form element <Select> missing accessible label (label, aria-label, or aria-labelledby) | `src/features/subscriptions/components/AddSubscriptionModal.tsx` | 304 |
| accessibility | Form element <Input> missing accessible label (label, aria-label, or aria-labelledby) | `src/shared/components/NavigationHeader.tsx` | 136 |
