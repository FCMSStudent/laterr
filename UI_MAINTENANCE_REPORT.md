...
Generated on: 3/11/2026, 1:41:32 AM
...
| --- | --- | --- | --- |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Landing": Error: Potential text overflow in <button> on Landing: "Get Started..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Significant element overlap detected (100%) on Dashboard between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "Forgot password?" is 98.1875x16 at (457, 436) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Potential text overflow in <button> on Dashboard: "Sign In..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Potential text overflow in <button> on Dashboard: "Continue as Guest (A..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Dashboard": Error: Small touch target detected on Dashboard: <button> "Don't have an accoun" is 204.734375x20 at (457, 617) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Significant element overlap detected (100%) on Bookmarks between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "Forgot password?" is 98.1875x16 at (457, 436) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Potential text overflow in <button> on Bookmarks: "Sign In..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Potential text overflow in <button> on Bookmarks: "Continue as Guest (A..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Bookmarks": Error: Small touch target detected on Bookmarks: <button> "Don't have an accoun" is 204.734375x20 at (457, 617) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Significant element overlap detected (100%) on Subscriptions between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "Forgot password?" is 98.1875x16 at (457, 436) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Potential text overflow in <button> on Subscriptions: "Sign In..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Potential text overflow in <button> on Subscriptions: "Continue as Guest (A..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Subscriptions": Error: Small touch target detected on Subscriptions: <button> "Don't have an accoun" is 204.734375x20 at (457, 617) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Significant element overlap detected (100%) on Health between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "Forgot password?" is 98.1875x16 at (457, 436) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Potential text overflow in <button> on Health: "Sign In..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Potential text overflow in <button> on Health: "Continue as Guest (A..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Health": Error: Small touch target detected on Health: <button> "Don't have an accoun" is 204.734375x20 at (457, 617) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 36x36 at (320, 11) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 36x36 at (320, 11) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (431.328125, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (431.328125, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (631.984375, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (631.984375, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (832.65625, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (832.65625, 234) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 409) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 409) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 487) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 487) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 565) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "" is 16x16 at (359, 565) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "Clear" is 65.125x36 at (856.875, 769) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "Reset" is 67.125x36 at (854.875, 851) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Settings": Error: Small touch target detected on Settings: <button> "Sign Out" is 590x40 at (345, 1052) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "" is 36x36 at (1228, 16) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Significant element overlap detected (100%) on Auth between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "" is 16x16 at (795, 390) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "Forgot password?" is 98.1875x16 at (457, 436) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Potential text overflow in <button> on Auth: "Sign In..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Potential text overflow in <button> on Auth: "Continue as Guest (A..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Auth": Error: Small touch target detected on Auth: <button> "Don't have an accoun" is 204.734375x20 at (457, 617) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Dashboard" is 80.421875x28 at (168.765625, 343.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Bookmarks" is 81.421875x28 at (249.1875, 343.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 380x40 at (351.609375, 337.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Add Item" is 108.59375x32 at (986.40625, 341.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (1107, 341.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (1107, 341.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 36x36 at (1151, 339.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 36x36 at (1151, 339.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (1199, 341.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (1199, 341.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (57, 1039.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 32x32 at (57, 1039.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Home" is 55.296875x32 at (121, 1039.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Documents" is 93.421875x32 at (208.296875, 1039.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "$245/mo • 8 active •" is 1140x24 at (70, 1424.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3105.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3193.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Significant element overlap detected (100%) on Components Showcase between <input> "" and <button> "" | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (1195, 3205.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (1195, 3205.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3281.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3369.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3483.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3695.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 3783.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 4571.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <input> "" is 1166x40 at (57, 4687.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4895.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4895.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4919.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4919.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4943.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 4943.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 44x24 at (57, 5099.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 5139.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 5139.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 5171.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "" is 16x16 at (57, 5171.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Potential text overflow in <button> on Components Showcase: "..." | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Open Dialog" is 123.078125x40 at (57, 5416.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Open Drawer" is 131.078125x40 at (57, 5596.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Delete Account" is 142.546875x40 at (57, 5776.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Open Sheet (Right)" is 168.84375x40 at (57, 5956.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Open Popover" is 138.890625x40 at (57, 6136.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "@username" is 121.421875x40 at (57, 6316.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Hover for Tooltip" is 156.015625x40 at (57, 6496.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Show PageLoading" is 170.1875x40 at (57, 7352.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Account" is 88.78125x36 at (63, 7971.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Password" is 99.59375x36 at (151.78125, 7971.59375) | `runtime` | - |
| accessibility | Runtime audit failure in "Overlapping and misaligned elements check for Components Showcase": Error: Small touch target detected on Components Showcase: <button> "Settings" is 87.59375x36 at (251.375, 7971.59375) | `runtime` | - |
...
| accessibility | Runtime audit failure in "Full accessibility audit for Landing": AssertionError: 4 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Dashboard": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Bookmarks": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Subscriptions": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Health": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Settings": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Auth": AssertionError: 3 accessibility violations were detected | `runtime` | - |
| accessibility | Runtime audit failure in "Full accessibility audit for Components Showcase": AssertionError: 7 accessibility violations were detected | `runtime` | - |
