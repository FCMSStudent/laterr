...
Generated on: 3/26/2026, 1:20:38 AM
...
| accessibility | Form element <Textarea> missing accessible label (aria-label or associated <label>) | `src/features/bookmarks/components/DetailItemNotesField.tsx` | 37 |
...
| accessibility | Form element <input> missing accessible label (aria-label or associated <label>) | `src/features/bookmarks/components/RichNotesEditor.tsx` | 341 |
...
| accessibility | Form element <Input> missing accessible label (aria-label or associated <label>) | `src/features/bookmarks/components/NoteEditorModal.tsx` | 100 |
...
| accessibility | Form element <Input> missing accessible label (aria-label or associated <label>) | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 216 |
| accessibility | Form element <Input> missing accessible label (aria-label or associated <label>) | `src/features/bookmarks/components/CardDetailRightPanel.tsx` | 241 |
